...
If you should want to export this again for any reason:
  http://terrain.party/api/export?name=iasi&box=27.693741,47.221300,27.455660,47.059604
...
[!] If you look at one height map, look at this one. [!]
  ...
  * iasi Height Map (SRTM3 v4.1).png
  ...
  * iasi Height Map (SRTM30 Plus).png
